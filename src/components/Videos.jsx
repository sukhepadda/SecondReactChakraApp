...
function Videos() {
    ...
    const DescArr = [
        'THis is the Description of The Sample Video 1',
        'THis is the Description of The Sample Video 2',
        'THis is the Description of The Sample Video 3',
        'THis is the Description of The Sample Video 4',
        'THis is the Description of The Sample Video 5',
        'THis is the Description of The Sample Video 6',
        'THis is the Description of The Sample Video 7',
      ];
    
      const [videoSrc, setVideoSrc] = useState(videosArr[0]);
      const [videoHeading, setvideoHeading] = useState(HeadingArr[0]);
      const [videoDesc, setvideoDesc] = useState(DescArr[0]);
  ...
  return (
    <Stack direction={['column', 'row']} h={'100vh'}>
      ...
      {videosArr.map((item, index) => (
        <Button variant="ghost" colorScheme="purple" onClick={() => {setVideoSrc(item), setvideoHeading(item), setvideoDesc(item)}}>
          Lecture {index + 1}
        </Button>
      ))}
      </VStack>
